...
public class ShowCorrectAndAmount1 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		total=intent.getStringExtra(QuestionAndAnswer1.EXTRA_MESSAGE1);
		correctAnswer=intent.getStringExtra(QuestionAndAnswer1.EXTRA_MESSAGE2);
	...
	public void onClick(View v){
		if(totalAmount>=100000){
			Intent intent=new Intent(this,QuestionTypePage2.class);
