...
public class QuestionTypePage1 extends Activity implements OnClickListener,RadioGroup.OnCheckedChangeListener{
	Button btnGo;RadioGroup group;String questionType;
	int id,id1,id2;String index;int random1,random2;
	...
	int totalAmount;String total;
	protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questiontypepage);
        Intent intent=getIntent();
        total=intent.getStringExtra(ShowCorrectAndAmount.EXTRA_MESSAGE1);
	...
	public void onClick(View v) {
			if(questionType!=null){
				Intent intent=new Intent(this,QuestionAndAnswer1.class);
				intent.putExtra(EXTRA_MESSAGE1,total);
				//intent.putExtra(EXTRA_MESSAGE2,level);
