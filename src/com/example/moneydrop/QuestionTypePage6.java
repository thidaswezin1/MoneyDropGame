...
public class QuestionTypePage6 extends Activity implements OnClickListener,RadioGroup.OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        total=intent.getStringExtra(ShowCorrectAndAmount5.EXTRA_MESSAGE1);
	...
	public void onClick(View v) {
			if(questionType!=null){
				Intent intent=new Intent(this,QuestionAndAnswer6.class);
