...
public class QuestionTypePage3 extends Activity implements OnClickListener,RadioGroup.OnCheckedChangeListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        total=intent.getStringExtra(ShowCorrectAndAmount2.EXTRA_MESSAGE1);
	...
	public void onClick(View v) {
			if(questionType!=null){
				Intent intent=new Intent(this,QuestionAndAnswer3.class);
