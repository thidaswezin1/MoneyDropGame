...
public class QuestionTypePage2 extends Activity implements OnClickListener,RadioGroup.OnCheckedChangeListener{
	...
	public void onClick(View v) {
			if(questionType!=null){
				Intent intent=new Intent(this,QuestionAndAnswer2.class);
