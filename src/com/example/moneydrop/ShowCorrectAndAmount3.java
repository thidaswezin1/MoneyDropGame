...
public class ShowCorrectAndAmount3 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showcorrectandamount);
		Intent intent=getIntent();
		total=intent.getStringExtra(QuestionAndAnswer3.EXTRA_MESSAGE1);
		correctAnswer=intent.getStringExtra(QuestionAndAnswer3.EXTRA_MESSAGE2);
	...
	public void onClick(View v){
		if(totalAmount>=100000){
			Intent intent=new Intent(this,QuestionTypePage4.class);
