...
public class ShowCorrectAndAmount7 extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.showcorrectandamount2);
		Intent intent=getIntent();
		total=intent.getStringExtra(QuestionAndAnswer7.EXTRA_MESSAGE1);
		correctAnswer=intent.getStringExtra(QuestionAndAnswer7.EXTRA_MESSAGE2);
